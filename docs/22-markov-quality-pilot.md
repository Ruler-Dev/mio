...
Its final clean-tree suite, lint, formatting, JSON, privacy, and source-lock
attestations must be recorded here and committed before the single authorized
inference attempt. The v4 native start will independently bind the eventual
clean Git revision and complete 34-file critical-source digest.
