...
| Paired scoring ablation | Native stride 1 and FP32-renormalized stride 8 produced identical text, token IDs, token counts, and finish reasons on 32/32 tasks. Scoring time was 4.978x lower in the joint FP32/stride-8 condition, while total adapter generation was 0.153% slower. | Paired AUROC and AURC intervals crossed zero and point estimates favored native scoring. This is no routing-quality or end-to-end speedup claim. |
