...
from mio.turboquant.cache import make_causal_mask
from mio.turboquant.rotation import (
    generate_rotation_matrix,
    generate_jl_matrix,
    build_combined_rot_jl,
    safe_normalize,
)
from mio.turboquant.qjl import qjl_encode
...
class TurboQuantKVCacheV2:
    ...
    def update_and_fetch(self, keys: mx.array, values: mx.array):
        ...
        # Force memory ordering: indexed assignments above are lazy. Without
        # this eval, DFlash's verify+rollback cycles can issue command buffers
        # that read stale slices, causing Metal GPU hangs.
        mx.eval(*self.keys, *self.values, self.key_norms, self.value_norms)
